...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // User created account. Now redirect to login page.
        navigate('/login');
      } else {
  ...
  return (
    <div className="login-container">
      <div className="login-card glass-panel" style={{ marginTop: '2rem', marginBottom: '2rem' }}>
        ...
        <div className="login-header">
          ...
          <p>Join PlaceWise to start your journey</p>
        </div>
        ...
        <form className="login-form" onSubmit={handleSignup}>
          ...
          <button type="submit" className="btn btn-primary login-btn" style={{ marginTop: '1rem' }}>
            Sign Up
          </button>
        </form>
